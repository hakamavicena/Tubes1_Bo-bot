...
Bot zoro mengandalkan algoritma greedy yang membagi operasionalnya ke dalam empat tahap strategis, yaitu **ekspansi wilayah (Expand), pengamanan perbatasan (Border), penetrasi teritori lawan (Conquer), dan serangan total (Blitzkrieg)**. Pada tahap awal, robot soldier melakukan pemetaan sektor secara menyebar untuk menguasai tile kosong, yang kemudian diikuti oleh pembangunan tower pada teritori sekutu dengan tipe yang disesuaikan berdasarkan kondisi ancaman di sekitar ruin. Saat wilayah kekuasaan mencapai ambang batas kritis, bot beralih ke mode Blitzkrieg di mana seluruh unit tempur seperti mopper dan splasher dipusatkan untuk menyerbu lokasi cermin lawan guna mengunci kemenangan mutlak.
...
- menyerang teritori musuh yang berbatasan langsung dengan teritori sekutu dan menelusuri ke dalamnya!
---
